...
FEATURE_EXTRACTORS = {
    "Budiarjo": (
        "SPARS.Gym.features.Budiarjo:feature_extraction"
    ),
}

TRANSLATORS = {
    "Budiarjo": (
        "SPARS.Gym.translators.Budiarjo:action_translator"
    ),
}

REWARDS = {
    "Budiarjo": (
        "SPARS.Gym.rewards.Budiarjo:Reward"
    ),
}

LEARNERS = {
    "Budiarjo": (
        "SPARS.Gym.learners.Budiarjo:learn"
    ),
}
