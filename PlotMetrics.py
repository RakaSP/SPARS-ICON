...
def algorithm_base_label(run_name):
    ...
    if lower_name.startswith("snf_ssc_af"):
        return "SNF+SSC AF"

    if lower_name.startswith("snf_ssc"):
        return "SNF+SSC"

    if lower_name.startswith("snf_ipm"):
        return "SNF+IPM"
    ...
    if lower_name.startswith("snf_icon"):
        return "SNF+SSC"

    # Backward-compatible aliases for directories not renamed yet.
    if lower_name.startswith("snf_mp_psas"):
        return "SNF+SSC"

    if lower_name.startswith("snf_psas"):
        return "SNF+IPM"
